...
\textit{Step} 4: Select, organize, and pre-process several datasets with real trajectory data for the experimental evaluation.%, such as San Francisco taxi dataset from the CRAWDAD project\cite{epfl-mobility-20090224}, the Geolife dataset \cite{zheng2009mining},  synthetic data, such as generated by Hermoupolis tool\cite{Pelekis-Hermoupolis}, and others.
